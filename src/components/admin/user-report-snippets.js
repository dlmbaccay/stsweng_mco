...
export function UserReportSnippet({ post }) {
    ...
    return (
        <>
            ...
            <Card className="w-full drop-shadow-md hover:drop-shadow-md min-h-fit rounded-md p-4 flex flex-col">

                {/* header */}
                <div id="post-header" className="flex flex-col justify-between">
                    <div className="flex flex-row w-full justify-end border-b border-secondary pb-2 mb-4">
