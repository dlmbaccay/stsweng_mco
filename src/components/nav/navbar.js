...
export default function ExpandedNavBar({props}) {
    ...
    const { uid, username, userPhotoURL } = props;
    ...
    return (
        <>
            <div ref={navRef} onClick={handleClick} className={`w-full h-screen border-r-2 border-gray flex flex-col justify-between bg-white dark:bg-dark_gray ${isExpanded ? "w-80 transition-all duration-300": "transition-all duration-300"}`}>
                <>
                {/* user meta */}
                <div className="pt-4 mx-auto">
                    ...
                    <div className="mx-auto flex flex-row items-center justify-center gap-4 mt-4">
                ...
                <div className="pb-8">
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <hr className={`border border-xanthous opacity-30 ml-6 mr-6 mt-6 mb-6 ${isExpanded ? "justify-items-start" : ""}`}/>
                        {/* Home Button */}
                        <button 
                            onClick={() => router.push('/home')} className={`mx-auto flex flex-row items-center gap-2`}>
                            ...
                            {isExpanded && <span className="text-muted_blue dark:text-light_yellow font-semibold">Home</span>}
                        </button>

                        {/* Pet Tracker Button */}
                        <button 
                            onClick={() => router.push('/pet-tracker')} className='mx-auto flex flex-row items-center gap-2'>
                            <div className="p-1 bg-muted_blue rounded-full dark:bg-light_yellow">
                                <svg class="w-6 h-6 text-white dark:text-dark_gray" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {isExpanded && <span className="text-muted_blue dark:text-light_yellow font-semibold">Pet Tracker</span>}
                        </button>
                        ...
                        <button 
                            ...
                            {isExpanded && <span className="text-muted_blue dark:text-light_yellow font-semibold">Notifications</span>}
                        </button>
                        ...
                        <button 
                            ...
                            {isExpanded && <span className="text-muted_blue dark:text-light_yellow font-semibold">Profile</span>}
                        </button>

                        {/* Settings Button */}
                        <button 
                            onClick={() => router.push('/settings')} className='mx-auto flex flex-row items-center gap-2'>
                            <div className="p-1 bg-muted_blue rounded-full dark:bg-light_yellow">
                                <svg class="w-6 h-6 text-white dark:text-dark_gray" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {isExpanded && <span className="text-muted_blue dark:text-light_yellow font-semibold">Settings</span>}
                        </button>
                    ...
                    {/* Log Out Button */}
                    <button onClick={() => handleSignOut()} className='mx-auto flex flex-row items-center gap-2'>
                        <div className="p-1 bg-muted_blue rounded-full dark:bg-light_yellow">
                        ...
                        {isExpanded && <span className="text-muted_blue dark:text-light_yellow font-semibold">Log Out</span>}
                    </button>
                </div>
