            ...
            <DialogContent className="sm:max-w-[600px] lg:max-w-[1080px]">
                ...
                <>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Make changes to your pet&apos;s profile here. Click save when you&apos;re done.
                        </DialogDescription>
                    </DialogHeader>
                        ...
                        <div className="flex flex-row w-full mb-4">
                            ...
                            <div className="flex flex-col w-2/3 px-20">
                                ...
                                <div className="flex flex-col items-left">
                                    <Label htmlFor="pet-name" className="text-left text-lg font-normal">
                                        Pet Name
                                    </Label>
                                    <Input 
                                        type="text" 
                                        id="pet-name" 
                                        value={newPetName} 
                                        className={`border border-slate-400 mt-2 p-2 rounded-md w-full ${newPetName === '' ? '': !checkDisplayName(newPetName) ? 'border-red-500' : 'border-green-500'}`} 
                                    ...
                                    { showDisplayNameTooltip  && (
                                        <div className="mt-4 flex flex-row w-full pl-2 gap-4">
                                            <div>
                                                <p className={`text-xs ${newPetName.length >= 1 && newPetName.length <= 30 ? 'text-green-500' : 'text-slate-400'}`}>- Be 1-30 characters long.</p>
                                                <p className={`text-xs ${/^[^\s]+(\s+[^\s]+)*$/.test(newPetName) ? 'text-green-500' : 'text-slate-400'}`}>- No blank spaces on either ends.</p>
                                            </div>
                                        </div>
                                    )}
                                </div>
                                ...
                                {/* Pet Favorite Food */}
                                <div className="mt-4">
                                    <Label htmlFor="favorite_food" className="text-left text-lg font-normal mt-2">
                                        Favorite Food
                                    </Label>
                                    <Input 
                                        type="text" 
                                ...
                                {/* Pet Hobbies */}
                                <div className="mt-4">
                                    <Label htmlFor="hobbies" className="text-left text-lg font-normal mt-2">
                                        Hobbies
                                    </Label>
                                    <Input 
                                        type="text" 
