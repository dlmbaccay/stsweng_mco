...
function BanPage() {
    ...
    return (
        ...
        <div className='mt-20 max-sm:text-center max-sm:mt-3'>
            ...
            <p className="mt-4 max-sm:mt-2 text-raisin_black text">You will not be able to access your account {userBan.status === "temporary" ? "until "+convertTimestampToDate(userBan.until) : "INDEFINITELY"}.</p>
...
export default WithAuth(BanPage);