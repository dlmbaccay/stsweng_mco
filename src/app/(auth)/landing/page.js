...
export default function Landing() {
	...
	function PostShowcase() {
		...
		const authorPhotoURL = signingUp
			? '/images/sample-user2-image.png'
			: '/images/sample-user1-image.png'
		const postDate = signingUp ? '31/11/6 at 21:00' : '23/9/6 at 16:30'
		const postBody = signingUp
			? 'Whisker Wonderland! 🐾🌿 Playtime in the park with our curious cats. Watching them explore and frolic is pure joy! #CatsofthePark #PurrfectDay'
			: 'Park Adventures with Max! 🐶🌳 Our Golden Retriever loves chasing frisbees and making friends. #GoldenDays #HappyPaws 🐾'
		const imageUrls = signingUp
			? ['/images/sample-user2-post.png']
			: ['/images/sample-user1-post.png']
		...
		return (
			<Card className="border border-slate-400 drop-shadow-md w-[650px] min-h-[500px] rounded-3xl p-6 flex flex-col hidden lg:flex mr-10">
				...
				<div id="post-body" className="mt-4 flex flex-col">
					...
					<div
						id="post-image"
						className="mt-4 h-[310px] w-auto flex items-center justify-center relative"
					>
						<Image
							src={imageUrls[0]}
							alt="post image"
